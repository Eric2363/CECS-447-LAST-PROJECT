...
/**********************************************************/
#ifndef USE_HIGH
#define MPU6050_ADDR_AD0_LOW		(0x68)// MPU6050 I2C Address when AD0 pin is pulled low
#else
//Only use if AD0 is pulled high
#define MPU6050_ADDR_AD0_HIGH		(0x69)// MPU6050 I2C Address when AD0 pin is pulled high
#endif

/*************Sampling Rate Register*************/
#define SMPLRT_DIV							(0x19)
//	#define SMPLRT_DIV_1					(0x00)
//	#define SMPLRT_DIV_2					(0x01)
//	#define SMPLRT_DIV_3					(0x02)
//	#define SMPLRT_DIV_4					(0x03)
//	#define SMPLRT_DIV_5					(0x04)
//	#define SMPLRT_DIV_6					(0x05)
//	#define SMPLRT_DIV_7					(0x06)
	#define SMPLRT_DIV_8					(0x07)

/****************Config Register****************/
#define CONFIG								(0x1A)
	#define CONFIG_DFPL_0					(0x00)
//	#define CONFIG_DFPL_1					(0x01)
//	#define CONFIG_DFPL_2					(0x02)
//	#define CONFIG_DFPL_3					(0x03)
//	#define CONFIG_DFPL_4					(0x04)
//	#define CONFIG_DFPL_5					(0x05)
//	#define CONFIG_DFPL_6					(0x06)
...
//	#define PWR_CLK_SEL_PLL_X 		(0x01)
//	#define PWR_CLK_SEL_PLL_Y		(0x02)
//	#define PWR_CLK_SEL_PLL_Z		(0x03)
//	#define PWR_CLK_SEL_EXT_32		(0x04)
//	#define PWR_CLK_SEL_EXT_19		(0x05)
//	#define PWR_CLK_SEL_STOP		(0x06)
//	#define PWR_TEMP_DIS			(0x08)
//	#define PWR_CYCLE			    (0x10)
//	#define PWR_SLEEP				(0x20)
